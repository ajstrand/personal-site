...
const y = T({}), b = (e) => {
  const {
    ...
    getFootnoteId: l,
    register: f
  } = F(y), a = m(() => s(e), [s, e]), t = m(() => l(e), [l, e]), o = m(() => ({
    idRef: a,
    idNote: t,
    description: n
  }), [a, t, n]);
...
const L = (e) => {
  ...
  return g(i, {
    "data-a11y-footnotes-footer": !0,
    role: "doc-endnotes",
    children: [c(s, {
      "data-a11y-footnotes-title": !0,
      id: d
    }), c(l, {
      "data-a11y-footnotes-list": !0,
      children: t.map(({
        idNote: o,
        idRef: r,
        description: R
        ...
        id: o,
        "data-a11y-footnotes-list-item": !0,
        children: [R, " ", c(a, {
...
const C = ({
  ...
  const [d, i] = x(/* @__PURE__ */ new Map()), s = u(({
    id: t,
    children: o
  }) => t || w(o), []), l = u((t) => s(t) + "-ref", [s]), f = u((t) => s(t) + "-note", [s]);
