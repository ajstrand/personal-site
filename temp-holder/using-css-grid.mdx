...
// `css // main { // grid-column-start: 1; // grid-column-end: end; // grid-row-start: 1; // grid-row-end: 3; // } // `

// Footer:

// `css // footer { // grid-row-start: 2; // grid-row-end: end; // grid-column-start: 1; // grid-column-end: end; // } // `
...
// `css // div { // grid-template-rows: "1fr 1fr"; // @media screen and (min-width: 30em) { // grid-template-rows: "1fr 50px"; // } // } // `
