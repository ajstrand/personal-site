...
var Block = function (props) {
  ...
  return Tag
    ...
    : React.createElement("p", null, "component was not rendered");
};
...
var StyledResume = function StyledResume(_ref) {
  var resumeDataObj = _ref.resumeDataObj;

  var _useState = useState(defaultResumeDataObj),
